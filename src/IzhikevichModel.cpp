 ...
 */
bool ode::IzhikevichModel::equals(const IzhikevichModel* other){
...
void ode::IzhikevichModel::detachObserver(SpikeObserver& observer){
...
void ode::IzhikevichModel::notifyObservers(){
	for(SpikeObserver* observer: this->observers)
		observer->spikeFired(this->time);
}